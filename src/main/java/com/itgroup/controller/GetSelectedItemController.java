...
public class GetSelectedItemController implements Initializable {
    @FXML public ImageView targetImage;
    @FXML private ComboBox leftCombo, rightCombo;
    ...
    public void selectLeft(ActionEvent actionEvent) {
        ...
        // 여러 개의 리스트들에서 category가 selectedCategory와 동일한 품목만 추출합니다.
        ...
        // 우측 콤보 박스 rightCombo에 항목들을 추가합니다.
